...
const SoftwareServices = () => {
  ...
  return (
    <>
    <div className="blogsbg text-white pt-10 md:pt-32 pb-12 md:pb-16 lg:pt-24 lg:pb-24 inset-0 -z-10 bg-gradient-to-br from-[#012546] via-surface-container-lowest to-[#013e76] pointer-events-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div>
            <BreadCrumbNav label="All Services"/>
            <h1 className="text-3xl sm:text-5xl font-headline font-bold tracking-tighter mb-6 max-w-2xl">
