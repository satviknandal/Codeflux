        ...
        <div className='gap-12 py-2 md:gap-24 md:py-12'>
            <div className="w-full md:space-y-6 md:col-span-2">
              ...
              <div className="py-8 md:w-3/4">
                <a href="/client-stories/wamsi/">
                <h3 className="text-gray-700 text-sm md:text-lg font-medium mb-2 md:mb-4">WAMSI (West Australian Marine Science Institue)</h3>
                <h4 className="text-xl md:text-3xl mb-2.5 font-medium md:mb-6">Modernising the Digital Home of WA’s Leading Marine Science Institution</h4>
                <span className="block text-sm md:text-base">We partnered with WAMSI to refresh their website, creating a clear and intuitive platform that better showcases their research, improves access to publications, and supports their role as a leader in marine science across Western Australia.</span></a></div></div>
        </div>
          ...
          <div className='w-full md:space-y-6 md:max-w-[480px]'>
            ...
            <div className='py-8'>
              <a href="/client-stories/perth-is-ok/">
                <h3 className="text-gray-700 text-sm md:text-lg font-medium mb-2 md:mb-4">Perth is OK!</h3>
                <h4 className="text-xl md:text-3xl mb-2.5 font-medium md:mb-6">Transforming Perth’s Leading Social Site with Innovative Digital Solutions</h4>
                <span className="block text-sm md:text-base">In collaboration with @blockbranding, we gave PiOK a vibrant overhaul using NextJS. The new site not only amped up user engagement but also nailed Google's Core Web Vitals, taking user satisfaction to the next level. Check out how we are helping to turn Perth's largest independent digital media outlet in Western Australia into an online powerhouse!</span>
              </a>
            </div>
          </div>
