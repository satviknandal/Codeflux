...
const WhyChooseCodefluxAIConsulting: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-pink-700 py-[90px] font-sans"
    >
      {/* Background Image */}
      <div
      ...
      {/* Background Overlay */}
      <div className="absolute inset-0 z-[1] bg-[linear-gradient(135deg,rgba(229,43,139,0.88)_0%,rgba(94,38,242,0.72)_50%,rgba(229,43,139,0.88)_90%)]" />
            ...
            return (
              ...
              >
                ...
                <div className="relative z-[1]">
                  {/* Icon */}
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl border border-pink-300/30 bg-pink-200/15 transition-all duration-300 group-hover:scale-[1.08] group-hover:border-pink-600 group-hover:bg-pink-400">
                    <Icon className="text-[20px] text-pink-400 transition-colors duration-300 group-hover:text-white" />
                  </div>
                  ...
                  {/* Description */}
                  <p className="text-sm font-normal leading-[1.5] text-gray-200/80">
                    {feature.description}
                  </p>
                </div>
              </div>
