...
import AppFlow from './home/AppFlow';
...
const InteractiveDots = ({
  ...
  const animate = useCallback(() => {
    ...
    dotsRef.current.forEach((dot) => {
      ...
      const hoverAmount = Math.min(mouseInfluence, 1);
  ...
  return (
    <div
      className="w-full absolute z-10 top-0 overflow-hidden h-[880px]"
      style={{ backgroundColor }}
    >
      <canvas ref={canvasRef} className="z-10 block w-full h-full" />
